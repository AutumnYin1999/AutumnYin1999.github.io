    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-6">
        ...
        <div className="space-y-4">
          {/* 总投资额 */}
          <div>
            <div className="text-base text-gray-500 mb-1">{language === 'zh' ? '总投资额' : 'Total Investment'}</div>
          ...
          <div className="border-t border-gray-100 pt-3">
            <div className="text-base text-gray-500 mb-1">{language === 'zh' ? '持仓市值' : 'Current Value'}</div>
            <div className="flex items-center justify-between">
          ...
          {/* 累计收益 */}
          <div className="border-t border-gray-100 pt-3">
            <div className="text-base text-gray-500 mb-1">{language === 'zh' ? '累计收益' : 'Acc. Returns'}</div>
            <div className="flex items-center justify-between">
          ...
          <div className="border-t border-gray-100 pt-3 flex space-x-4">
            <div className="flex-1">
              <div className="text-base text-gray-500 mb-1">{language === 'zh' ? '平均年化' : 'Avg Yield'}</div>
              <div className="text-xl font-bold text-gray-800">
                6.8%
              </div>
            </div>
            <div className="flex-1">
              <div className="text-base text-gray-500 mb-1">{language === 'zh' ? '持有资产数' : 'Holdings'}</div>
              <div className="text-xl font-bold text-gray-800">
