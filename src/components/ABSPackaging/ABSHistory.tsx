      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        {absProducts.length === 0 ? (
          <div className="text-center py-8 text-gray-500 text-base">
            ...
            <p className="text-sm text-gray-400 mt-1">{t('absPackaging.willShowAfterPackaging')}</p>
          </div>
        ) : (
            ...
            >
              ...
              <div className="space-y-2 mb-3">
                ...
                <div className="flex items-center justify-between text-base">
                  ...
                  <span className="text-gray-800 text-sm">{product.createdAt}</span>
                </div>
              </div>

              {/* 分层状态 */}
              <div className="border-t border-gray-200 pt-3 space-y-2">
                <div className="text-sm font-medium text-gray-700 mb-2">{t('absPackaging.layerStatus')}：</div>
              ...
              <div className="flex space-x-2 mt-3 pt-3 border-t border-gray-200">
                <button className="flex-1 px-3 py-1.5 bg-blue-50 text-blue-700 rounded text-sm font-medium hover:bg-blue-100 transition-colors">
                  {t('absPackaging.viewDetail')}
                </button>
                <button className="px-3 py-1.5 border border-gray-300 text-gray-700 rounded text-sm font-medium hover:bg-gray-50 transition-colors">
