              ...
              {[
                ...
                return (
                  <button
                    ...
                    className={`px-4 py-2 rounded-full text-base font-medium transition-colors border ${isSelected
        ...
        <div>
          ...
          <div className="flex space-x-3 mt-2">
            <label className="flex items-center cursor-pointer">
              ...
              />
              <span className="ml-2 text-base text-gray-700">AR</span>
            </label>
            <label className="flex items-center cursor-pointer">
              <input
                type="checkbox"
                ...
                className="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
              />
              <span className="ml-2 text-base text-gray-700">ABS</span>
            </label>
          </div>
        </div>
          ...
          <div className="flex space-x-2">
            {['all', 'A', 'B', 'C'].map(rating => (
              <button
                ...
                className={`px-3 py-1.5 rounded-md text-base font-medium border transition-colors ${filters.riskLevel === rating
                  ? 'bg-blue-50 border-blue-200 text-blue-700'
                  : 'bg-white border-gray-200 text-gray-600 hover:bg-gray-50'
                  }`}
              >
        ...
        <div>
          ...
          <div className="flex items-center space-x-2">
            <input
              ...
              placeholder="Min"
              className="w-full px-3 py-1.5 border border-gray-300 rounded-lg text-base focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            />
        ...
        <div>
          ...
          <div className="flex items-center space-x-2">
            <input
              ...
              className="w-full px-2 py-1.5 border border-gray-300 rounded-lg text-base focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            />
            <span className="text-gray-400">-</span>
            <input
              type="date"
