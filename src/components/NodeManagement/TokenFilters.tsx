            ...
            {['all', 'bank', 'audit', 'cic'].map(type => {
              ...
              return (
                <button
                  ...
                  className={`px-3 py-1.5 rounded-md text-base font-medium border transition-colors ${isSelected
        ...
        <div>
          ...
          <div className="relative">
            <input
              ...
              className="w-full pl-9 pr-3 py-2 border border-gray-300 rounded-lg text-base focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            />
